...
public class MatchStatisticsKeeperTest {
    ...
    public void matches_as_class_going_1st_are_correct2() {
        bool = forLoop1ClassException(keeper.getStatistics().getMatchesAsClass1st(), DeckClass.SHAMAN);
        assertTrue(bool);
    }

    private boolean forLoop1ClassException(Map<DeckClass, Integer> map, DeckClass exception) {
    ...
    public void matches_as_class_going_2nd_are_correct3() {
        bool = forLoop2ClassException(keeper.getStatistics().getMatchesAsClass2nd(), DeckClass.PRIEST, DeckClass.SHAMAN);
        assertTrue(bool);
    }

    private boolean forLoop2ClassException(Map<DeckClass, Integer> map, DeckClass exception1, DeckClass exception2) {
        for (DeckClass deckClass : dclist) {
    ...
    public void matches_vs_class_going_1st_is_correct4() {
        bool = forLoop3ClassException(keeper.getStatistics().getMatchesVSClass1st(), DeckClass.MAGE,
                DeckClass.PALADIN, DeckClass.ROGUE);
        assertTrue(bool);
    }

    private boolean forLoop3ClassException(Map<DeckClass, Integer> map, DeckClass exception1,
    ...
    public void matches_vs_class_going_2nd_is_correct4() {
        bool = forLoop3ClassException(keeper.getStatistics().getMatchesVSClass2nd(), DeckClass.MAGE,
    ...
    public void wins_as_class_going_1st_is_correct2() {
        bool = forLoop1ClassException(keeper.getStatistics().getWinsAsClass1st(), DeckClass.SHAMAN);
        assertTrue(bool);
    }
    ...
    public void wins_as_class_going_2nd_is_correct2() {
        bool = forLoop1ClassException(keeper.getStatistics().getWinsAsClass2nd(), DeckClass.SHAMAN);
        assertTrue(bool);
    }
    ...
    public void losses_as_class_going_1st_is_correct2() {
        for (DeckClass deckClass : dclist) {
            if (keeper.getLossesAsClass1st(deckClass) != 0 && deckClass != DeckClass.SHAMAN) {
                bool = false;
                break;
            }
        }
        bool = forLoop1ClassException(keeper.getStatistics().getLossesAsClass1st(), DeckClass.SHAMAN);
        assertTrue(bool);
    }
    ...
    public void losses_as_class_going_2nd_is_correct3() {
        bool = forLoop2ClassException(keeper.getStatistics().getLossesAsClass2nd(), DeckClass.SHAMAN, DeckClass.PRIEST);
        assertTrue(bool);
    }
    ...
    public void wins_vs_class_going_1st_is_correct2() {
        bool = forLoop1ClassException(keeper.getStatistics().getWinsVSClass1st(), DeckClass.MAGE);
        assertTrue(bool);
    }
    ...
    public void wins_vs_class_going_2nd_is_correct2() {
        bool = forLoop1ClassException(keeper.getStatistics().getWinsVSClass2nd(), DeckClass.DRUID);
        assertTrue(bool);
    }
    ...
    public void losses_vs_class_going_1st_is_correct2() {
        bool = forLoop1ClassException(keeper.getStatistics().getLossesVSClass1st(), DeckClass.PALADIN);
        assertTrue(bool);
    }
    ...
    public void losses_vs_class_going_2nd_is_correct3() {
        bool = forLoop2ClassException(keeper.getStatistics().getLossesVSClass2nd(), DeckClass.MAGE, DeckClass.WARRIOR);
        assertTrue(bool);
    }
    ...
    public void wins_in_class_vs_class_going_1st_is_correct2() {
        bool = forLoop1ClassPairException(keeper.getStatistics().getWinsInClassVSClass1st(), sVSm);
        assertTrue(bool);
    }

    private boolean forLoop1ClassPairException(Map<DeckClassPair, Integer> map, DeckClassPair exception) {
    ...
    public void wins_in_class_vs_class_going_2nd_is_correct2() {
        bool = forLoop1ClassPairException(keeper.getStatistics().getWinsInClassVSClass2nd(), sVSd);
        assertTrue(bool);
    }
    ...
    public void losses_in_class_vs_class_going_1st_is_correct2() {
        bool = forLoop1ClassPairException(keeper.getStatistics().getLossesInClassVSClass1st(), sVSpa);
        assertTrue(bool);
    }
    ...
    public void losses_in_class_vs_class_going_2nd_is_correct3() {
        bool = forLoop2ClassPairException(keeper.getStatistics().getLossesInClassVSClass2nd(),
                sVSm, prVSwarr);
        assertTrue(bool);
    }

    private boolean forLoop2ClassPairException(Map<DeckClassPair, Integer> map,
    ...
    public void win_percentage_as_class_going_1st_is_correct2() {
        bool = forLoop1ClassExceptionDouble(keeper.getStatistics().getWinPerAsClass1st(), DeckClass.SHAMAN);
        assertTrue(bool);
    }

    private boolean forLoop1ClassExceptionDouble(Map<DeckClass, Double> map, DeckClass exception) {
    ...
    public void win_percentage_as_class_going_2nd_is_correct2() {
        bool = forLoop1ClassExceptionDouble(keeper.getStatistics().getWinPerAsClass2nd(), DeckClass.SHAMAN);
        assertTrue(bool);
    }
    ...
    public void win_percentage_vs_class_going_1st_is_correct2() {
        bool = forLoop1ClassExceptionDouble(keeper.getStatistics().getWinPerVSClass1st(), DeckClass.MAGE);
        assertTrue(bool);
    }
    ...
    public void win_percentage_vs_class_going_2nd_is_correct2() {
        bool = forLoop1ClassExceptionDouble(keeper.getStatistics().getWinPerVSClass2nd(), DeckClass.DRUID);
    }
    ...
    public void win_percentage_class_vs_class_going_1st_is_correct2() {
        bool = forLoop1ClassPairExceptionDouble(keeper.getStatistics().getWinPerClassVSClass1st(), sVSm);
        assertTrue(bool);
    }

    private boolean forLoop1ClassPairExceptionDouble(Map<DeckClassPair, Double> map, DeckClassPair exception) {
        for (DeckClass dc1 : dclist) {
            for (DeckClass dc2 : dclist) {
                DeckClassPair dcp = new DeckClassPair(dc1, dc2);
                if (map.get(dcp) != 0 && !dcp.equals(exception)) {
    ...
    public void win_percentage_class_vs_class_going_second_is_correct2() {
        bool = forLoop1ClassPairExceptionDouble(keeper.getStatistics().getWinPerClassVSClass2nd(), sVSd);
        assertTrue(bool);
    }
    ...
    public void matches_as_class_total_is_correct2() {
        assertEquals(1, keeper.getMatchesAsClassTotal(DeckClass.PRIEST));
    }
    ...
    public void matches_vs_class_total_is_correct6() {
        assertEquals(0, keeper.getMatchesVSClassTotal(DeckClass.WARLOCK));
    }
    ...
    public void total_matches_is_correct() {
        assertEquals(10, keeper.getTotalMatches());
    }
