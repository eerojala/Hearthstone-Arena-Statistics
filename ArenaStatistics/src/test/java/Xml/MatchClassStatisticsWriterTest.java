...
public class MatchClassStatisticsWriterTest {

    StatisticsWriter writer;
    MatchClassStatisticsKeeper keeper1;
    MatchClassStatisticsKeeper keeper2;
    ...
    public MatchClassStatisticsWriterTest() {
        rogue = DeckClass.ROGUE;
        paladin = DeckClass.PALADIN;
        filepath = "src/main/resources/ClassStatisticsWriteTest.xml";
        writer = new MatchClassStatisticsWriter(filepath);
        doc = DocumentBuilder.buildDocument(filepath);
        keeper1 = new MatchClassStatisticsKeeper();
    ...
    private MatchClassStatisticsKeeper parseToKeeper() {
        parse();
        return parser.getKeeper();
    }

    private void parse() {
        parser = new MatchClassStatisticsParser(doc);
        parser.addValues();
    }
    ...
    public void update_specific_works_correctly() {
        ...
        writer.updateSpecific(doc, paladin, keeper1);
