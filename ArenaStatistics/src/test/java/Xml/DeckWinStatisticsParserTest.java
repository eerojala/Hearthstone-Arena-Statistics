...
public class DeckWinStatisticsParserTest {

    private final DeckWinStatisticsParser parser;
    private final DeckWinStatisticsKeeper keeper;

    public DeckWinStatisticsParserTest() {
        parser = new DeckWinStatisticsParser("src/main/resources/DeckWinStatisticsParseTest.xml");
        parser.addValues();
