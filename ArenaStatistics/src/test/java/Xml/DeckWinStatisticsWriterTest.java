...
public class DeckWinStatisticsWriterTest {

    private final StatisticsWriter writer;
    private DeckWinStatisticsKeeper keeper1;
    private DeckWinStatisticsKeeper keeper2;
    private DeckWinStatisticsParser parser;
    private final String filepath;
    private final Document doc;

    public DeckWinStatisticsWriterTest() {
    ...
    private DeckWinStatisticsKeeper parseToKeeper() {
        parse();
        return parser.getKeeper();
    }
    
    private void parse() {
        parser = new DeckWinStatisticsParser(filepath);
        parser.addValues();
    }
